...
#define HG_EVENT_CALL_NO_DATA( EVENT, PTHIS ) \
	if ( this->GetComponent<HG::HGBehaviour>()->EVENT != nullptr ) { this->GetComponent<HG::HGBehaviour>()->EVENT( nullptr, PTHIS ); }

#define HG_EVENT_CALL_SCENE_NO_DATA( EVENT, PTHIS ) \
	if ( EVENT != nullptr ) { EVENT( nullptr, PTHIS ); }

#define HG_EVENT_CALL( EVENT, PDATA, PTHIS ) \
	if ( this->GetComponent<HG::HGBehaviour>()->EVENT != nullptr ) { this->GetComponent<HG::HGBehaviour>()->EVENT( PDATA, PTHIS ); }
